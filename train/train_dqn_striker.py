...
class DQNStrikerAgent:
    def __init__(self, state_dim, action_dim):
        ...
        self.learn_step = 0
        self.action_dim = action_dim  # ← Fix: Added this for action range

    def choose_action(self, state):
        if np.random.rand() < self.epsilon:
            return random.randint(0, self.action_dim - 1)  # ← Fix: Correctly use action_dim
    ...
    def learn(self):
        ...
        # Double DQN: use main net to select action, target net to evaluate
        with torch.no_grad():
